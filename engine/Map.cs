...
namespace engine
{
    class Map
    {
        ...
        private static void DrawAreaMap(int partyDir, int partyMapY, int partyMapX)
        { /* sub_7100F */
        ...
        private static void Draw3dWorldBackground()
        {
        ...
        private static void draw_3D_8x8_titles(int offsetIndex, int arg_2, int rowStart, int colStart) /* sub_71434 */
        {
        ...
        private static bool MapCoordIsValid(int mapY, int mapX)
        { /*sub_71542*/
        ...
        private static MapInfo getMap_XXX(int mapY, int mapX)
        {
            MapInfo mi = null;
