...
namespace engine
{
    class Shop
    {
        private static char ShopChooseItem(ref int index, out Item selectedItem) // sub_2F04E
        {
        ...
        private static void shop_buy() /* sub_2F474 */
        {
            ...
            do
            {
                ...
                switch (inputKey)
                {
                    ...
                    case 'E':
                        ...
                        if (money_on_ground == true)
                        {
                            TextRenderer.press_any_key("As you Leave the Shopkeeper says, \"Excuse me but you have Left Some Money here.\"  ", true, 10, TextRegion.NormalBottom);
                            TextRenderer.press_any_key("Do you want to go back and get your Money?", false, 15, TextRegion.NormalBottom);
