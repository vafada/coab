...
namespace engine
{
    class Temple
    {
        ...
        {
            PartyPlayerFunctions.DisplayPlayerStatusString(false, 0, text, gbl.SelectedPlayer);
        ...
        private static bool buy_cure(int cost, string cure_name) /* buy_cure */
        {
            ...
            TextRenderer.press_any_key(text, true, 10, TextRegion.NormalBottom);
            ...
            {
                PartyPlayerFunctions.ClearPlayerTextArea();
                PartyPlayerFunctions.DisplayPlayerStatusString(true, 0, "is cured.", gbl.SelectedPlayer);
            }
