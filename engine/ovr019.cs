...
namespace engine
{
    class ovr019
    {
        ...
        internal static void endgame_529F4() /* sub_529F4 */
        {
            ...
            do
            {
                    ...
                    StringRandomIOUtils.Random(10000) < 1)
                {
                    ...
                    {
                        gbl.byte_1AE0A = KeyInputQueue.READKEY();
                    }
                }
        ...
        {
            int loop_count = 0;
            int start_time = TextRenderer.time01();
            ...
            do
            {
                ...
                int current_time = TextRenderer.time01();
        ...
        internal static void end_game_text()
        {
            ...
            TextRenderer.press_any_key(aTyranthraxusSp, true, 10, TextRegion.NormalBottom);
            TextRenderer.press_any_key(aStormGiant_You, false, 10, TextRegion.NormalBottom);
            TextRenderer.press_any_key(aTheAmuletOfLyt, false, 10, TextRegion.NormalBottom);
            TextRenderer.press_any_key(aYouOfYourVicto, false, 10, TextRegion.NormalBottom);
            TextRenderer.DisplayAndPause("Press any key to continue.", 13);

            TextRenderer.press_any_key(aAsYouReachForT, true, 10, TextRegion.NormalBottom);
            TextRenderer.press_any_key(aOutKeepTheGaun, false, 10, TextRegion.NormalBottom);
            TextRenderer.press_any_key(aWillUnleashDan, false, 10, TextRegion.NormalBottom);
            TextRenderer.press_any_key(aGauntletContac, false, 10, TextRegion.NormalBottom);
            ...
            TextRenderer.press_any_key(aIsSlainThisDay, false, 10, TextRegion.NormalBottom);
            TextRenderer.press_any_key(aNothingness_, false, 10, TextRegion.NormalBottom);
            ...
            TextRenderer.press_any_key(aHasFinallyBeen, false, 10, TextRegion.NormalBottom);
            TextRenderer.press_any_key(aLast, false, 10, TextRegion.NormalBottom);
            ...
            TextRenderer.press_any_key(aTheKnightsOfMy, true, 10, TextRegion.NormalBottom);
            TextRenderer.press_any_key(aCongratulati_0, false, 10, TextRegion.NormalBottom);
            TextRenderer.press_any_key(aWithThePowerOf, false, 10, TextRegion.NormalBottom);
            ...
            TextRenderer.press_any_key(aYouAreTeleport, true, 10, TextRegion.NormalBottom);
            TextRenderer.press_any_key(aHaveAlreadyBeg, false, 10, TextRegion.NormalBottom);
            TextRenderer.press_any_key(aGharriAndNacac, false, 10, TextRegion.NormalBottom);
            TextRenderer.press_any_key(aFromTheNearbyS, false, 10, TextRegion.NormalBottom);
            endgame_529F4();
